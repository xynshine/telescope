...
class Telescope(models.Model):
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, verbose_name='Пользователь телескопа', related_name='telescopes', null=True, default=None, on_delete=models.DO_NOTHING)
