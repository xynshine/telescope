...
urlpatterns = [
    ...
    re_path(r'^(?P<pk>\d+)/get_result/$', views.TaskResultView.as_view(), name='task_result'),
    re_path(r'^(?P<task_id>\d+)/add_result/$', views.ResultCreateView.as_view(), name='add_result'),
